...
export const getTop5ListByUserName = (id) => api.get(`/top5userlist/${id}`)
export const getTop5ListByListName = (id) => api.get(`/top5namelist/${id}`)
export const getPublishedTop5List = () => api.get(`/publishedtop5list/`)

export const getLoggedIn = () => api.get(`/loggedIn/`);
export const registerUser = (payload) => api.post(`/register/`, payload)
export const loginUser = (payload) => api.post(`/login/`, payload)
export const guess = () => api.get(`/guess/`);
